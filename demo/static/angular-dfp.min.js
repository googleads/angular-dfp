...
e,d,c){function u(a){if(0!==h.H.length){var b=googletag.sizeMapping();h.H.forEach(function(a){b.addSize(a.T,a.L)});a.defineSizeMapping(b.build())}}e=c.get("dfp");var p=c.get("dfpIDGenerator"),r=c.get("dfpRefresh"),v=c.get("responsiveResize"),h=d.m(),w=b;b=b[0];p(b);e.then(function(){var c=googletag.defineSlot(h.u,h.sizes,b.id);void 0!==h.C&&c.setForceSafeFrame(!0);h.J&&c.setClickUrl(h.J);void 0!==h.A&&c.setCollapseEmptyDiv(!0,!0);void 0!==h.s&&c.setSafeFrameConfig(JSON.parse(h.s));u(c);h.da.forEach(function(a){c.setTargeting(a.key,
a.values)});h.W.forEach(function(a){c.setCategoryExclusion(a)});h.scripts.forEach(function(a){a(c)});c.addService(googletag.pubads());googletag.display(b.id);r(c,h.refresh).then(function(){0<h.H.length&&v(w)});a.$on("$destroy",function(){console.error("death")});setTimeout(function(){a.$destroy()},3E3)})}d.directive("dfpAd",["$injector",function(a){return{restrict:"AE",controller:e,controllerAs:"controller",bindToController:!0,link:function(e){for(var d=[],f=0;f<arguments.length;++f)d[f-0]=arguments[f];
b.apply(null,d.slice(0,4).concat(a))},scope:{adUnit:"@",clickUrl:"@",forceSafeFrame:"@",safeFrameConfig:"@",refresh:"@",collapseIfEmpty:"@"}}}])})(y);(function(d){function e(b,a){var e=1E13*String(Math.random()),d="";b.u&&(d="dc_iu="+b.u);var f="";b.h&&(f="ppid="+b.h);var c=document.createElement("img");c.src="https://pubads.g.doubleclick.net/activity;ord=";c.src+=e+";dc_seg="+b.ba+";"+d+f;c.width=1;c.height=1;c.border=0;c.style.visibility="hidden";a.append(c)}d.directive("dfpAudiencePixel",[function(){return{restrict:"E",scope:{u:"@",ba:"@",h:"@"},link:e}}])})(y);(function(d){function e(b,a,e,d){d.N(a.html())}d.directive("dfpExclusion",[function(){return{restrict:"E",require:"^^dfpAd",link:e}}])})(y);(function(d){d.factory("dfpIDGenerator",[function(){function e(a){if(a&&a.id&&!(a.id in b))return a.id;var e=null;do e="gpt-ad-"+Math.random().toString().slice(2);while(e in b);b[e]=!0;a&&(a.id=e);return e}var b={};e.a=function(a){return a in b};e.l=function(a){return!e.a(a)};return e}])})(y);googletag=googletag||{};googletag.cmd=googletag.cmd||[];
...
d=e.reduce(function(a,b){return Math.max(a,b)}),g=0;g<a.length;++g)if(e[g]===d)switch(a[g]){case k.j:v();break;case k.i:w();break;case k.b:console.assert(c.l());m.v=!0;break;default:console.assert(!1)}else switch(a[g]){case k.j:h();break;case k.i:z();break;case k.b:m.v=!1;break;default:console.assert(!1)}}function r(a){console.assert(void 0===a||null!==a);void 0===a?googletag.pubads().refresh():0!==a.length&&(a=a.filter(function(a){return null!==a.I}),googletag.cmd.push(function(){googletag.pubads().refresh(a.map(function(a){return a.I}));
a.forEach(function(a){return a.V.resolve()})}))}function v(){console.assert(c.B());var a=d(function(){A();r()},b.o);q.refresh=a;m.refresh=!0}function h(){m.refresh&&(d.cancel(q.refresh),q.refresh=null,m.refresh=!1)}function w(){console.assert(c.w());var a=d(function(){r(t);A()},b.f);q.buffer=a;m.interval=!0}function z(){m.interval&&(d.cancel(q.buffer),q.buffer=null,m.interval=!1)}function A(){for(var a=0;a<t.length;++a)t[a]=null}function C(a,b){b=f(b);var e=d(function(){c.K()?B(a):r([a])},b);q[a.I]=
...
c;z();b.f=null;p();return c};c.w=function(){return null!==b.f};c.ua=function(){return m.interval};c.ga=function(){return b.f};c.ma=function(a,e){b.c=a;b.G=void 0===e?!0:e;p();return c};c.X=function(){c.l()?(b.c=null,p()):console.warn("clearBufferBarrier had not effect because no barrier was set.")};c.fa=function(){return b.c};c.l=function(){return null!==b.c};c.sa=function(){return m.v};c.ta=function(){return b.G};c.pa=function(a){b.o=f(a);v();p();return c};c.B=function(){return null!==b.o};c.ka=
function(){return m.refresh};c.xa=function(){c.B()||console.warn("clearRefreshInterval had no effect because no refresh interval was set.");h();p();return c};c.ia=function(){return b.o};c.K=function(){return m.buffer||m.interval};c.Z=function(a){switch(a){case k.j:return c.B();case k.i:return c.w();case k.b:return c.l();default:throw new e;}};c.D=function(a,c){if(!(a in k))throw new e;u(c);b.priority[a]=c};c.a=function(a){if(!(a in k))throw new e;return b.priority[a]};c.qa=function(a){u(a);c.D("refresh",
a)};c.ja=function(){return c.a("refresh")};c.la=function(a){u(a);c.D("barrier",a)};c.ea=function(){return c.a("barrier")};c.oa=function(a){u(a);c.D("interval",a)};c.ha=function(){return c.a("interval")};a.$on("$destroy",function(){console.log("destroy!");q.forEach(function(a){d.cancel(a)})});p();return c}]}])})(y);(function(d){function e(){function a(){return b.some(function(a){return"number"!==typeof a})?!1:0<e.length}var b=Object.seal([this.browserWidth,this.browserHeight||0]),e=[];this.addSize=function(a){e.push(a)};this.m=function(){console.assert(a());return Object.freeze({T:b,L:e})}}function b(a,b,e,d){a=a.controller.m();d.O(a)}e.a=["$scope"];d.directive("dfpResponsive",[function(){return{restrict:"E",require:"^^dfpAd",controller:e,controllerAs:"controller",bindToController:!0,link:b,scope:{browserWidth:"=",
browserHeight:"="}}}])})(y);(function(d){function e(b,a,e,d,f){a=f.get("dfpFormat")("(function(scope, {0}) { {1} })",b.ca||"slot",a.html().trim());d.P(eval(a).bind(null,b.scope))}d.directive("dfpScript",["$injector",function(b){return{restrict:"E",require:"^^dfpAd",scope:{ca:"@",scope:"="},link:function(a){for(var d=[],g=0;g<arguments.length;++g)d[g-0]=arguments[g];e.apply(null,d.concat(b))}}}])})(y);(function(d){function e(b,a,e,d){d=d[1]||d[0];console.assert(d);b.width&&b.height?d.addSize([b.width,b.height]):d.addSize(a[0].innerHTML)}d.directive("dfpSize",[function(){return{restrict:"E",require:["?^^dfpAd","?^^dfpResponsive"],scope:{width:"=",height:"="},link:e}}])})(y);(function(d){function e(){var a=this.value?[this.value]:[];this.F=function(){return void 0===this.key||0===a.length?!1:!0};this.m=function(){console.assert(this.F());return Object.freeze({key:this.key,values:a})};this.S=function(b){a.push(b)}}function b(a,b,e,d){console.assert(void 0!==d);a=a.controller.m();d.R(a)}d.directive("dfpTargeting",[function(){return{restrict:"E",require:"^^dfpAd",controller:e,controllerAs:"controller",bindToController:!0,scope:{key:"@",value:"@"},link:b}}])})(y);(function(d){function e(b,a,e,d){d.S(a.html())}d.directive("dfpValue",[function(){return{restrict:"E",require:"^^dfpTargeting",link:e}}])})(y);(function(d){function e(b,a,d,e){d=e.get("dfpIDGenerator");a=a[0];console.assert("VIDEO"===a.tagName);d(a,!0);d=videojs(a.id);d.ima({id:a.id,ra:b.M});d.ima.requestAds();d.ima.initializeAdDisplayContainer()}d.directive("dfpVideo",["$injector",function(b){return{restrict:"A",scope:{M:"@"},link:function(a){for(var d=[],g=0;g<arguments.length;++g)d[g-0]=arguments[g];e.apply(null,d.concat(b))}}}]);return d})(angular.module("angularDfp"));googletag=googletag||{};googletag.cmd=googletag.cmd||[];
...
c.l=function(){return d};c.then=function(a){googletag.cmd.push(a)};return c}]}])})(y);
